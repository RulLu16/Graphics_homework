...
void initialize_camera(void) {
	...
	camera.pos[0] = 4.0f / 6.0f * 500.0f; camera.pos[1] = 4.0f / 6.0f * 600.0f;  camera.pos[2] = 4.0f / 6.0f * 500.0f;
	ViewMatrix = glm::lookAt(4.0f / 6.0f * glm::vec3(500.0f, 600.0f, 500.0f),
		glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	camera.uaxis[0] = ViewMatrix[0][0]; camera.uaxis[1] = ViewMatrix[1][0]; camera.uaxis[2] = ViewMatrix[2][0];
	camera.vaxis[0] = ViewMatrix[0][1]; camera.vaxis[1] = ViewMatrix[1][1]; camera.vaxis[2] = ViewMatrix[2][1];
	camera.naxis[0] = ViewMatrix[0][2]; camera.naxis[1] = ViewMatrix[1][2]; camera.naxis[2] = ViewMatrix[2][2];

	camera.move = 0;
	camera.fovy = 45.0f, camera.aspect_ratio = 1.0f; camera.near_c = 100.0f; camera.far_c = 20000.0f;
...
void prepare_optimus(void) {
	...
	My_glTexImage2D_from_file("Data/static_objects/tiger_tex.jpg");
